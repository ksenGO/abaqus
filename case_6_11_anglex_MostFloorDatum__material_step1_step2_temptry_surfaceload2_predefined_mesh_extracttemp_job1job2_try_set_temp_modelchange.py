...
if temp1>20:
    print('yes')
    modelchangepoint1 = mdb.models['myModel'].rootAssembly.instances['Part-1-1'].cells.findAt(((0.35,0.02,0.35),))
    modelchange1= heatModel.rootAssembly.Set(cells = modelchangepoint1,name = 'modelchange1')
    weldModel = mdb.models['myModel']
    weldModel.ModelChange(name='gasification1',createStepName='Heating Step2',region = modelchange1,activeInStep=False,includeStrain = False)
else:
    print('no')
prettyPrint(temp1)
#modelchangge
...
s1 = a.instances['Part-1-1'].faces
yy=0.0+0.04
side1Faces1 = s1.findAt(((0.45,0.0,0.45),),((0.35,yy,0.35),),((0.45,0.0,0.35),))
region = a.Surface(side1Faces= side1Faces1,name ='Surf-1')
