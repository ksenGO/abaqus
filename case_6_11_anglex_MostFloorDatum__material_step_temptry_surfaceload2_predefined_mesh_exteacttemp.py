...
mdb.models['myModel'].SurfaceHeatFlux(name = 'heatload', createStepName = 'Heating Step', region=region,magnitude = 40000000)
...
side1Faces1 = s1.findAt(((0.45,0.0,0.45),),((0.35,0.0,0.35),),((0.45,0.0,0.35),))
region = a.Surface(side1Faces= side1Faces1,name ='Surf-1')
mdb.models['myModel'].SurfaceHeatFlux(name = 'heatload2', createStepName = 'Heating Step2', region=region,magnitude = 30000000)
heatModel.setValues(absoluteZero = -273.15,stefanBoltzmann=5.67E-8)
print ("step2 is ok")
