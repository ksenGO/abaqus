...
#DOWN_NUM
#down_num=dict(down_0_0=10,down_0_1=1,down_0_2=2)
down_num ={}
jm=10
mm=10
for x in range(1,jm+1,1):#x*jm
    for z in range(1,mm+1,1):#z*m
        down_num['down_{}_{}'.format(x,z)]=0
print(down_num)
#heatstepbysetp
...
for stepnum_i in range(1,totol_heat_stepnum):
    ...
    if stepnum_i == 1:
        ...
        for x in range(1,jm+1,1):#x*jm
            for z in range(1,mm+1,1):#z*m
                #down_num=dict(down_0_0=10,down_0_1=1,down_0_2=2)
                down_num_step['down_{}_{}_step'.format(x,z)]=0
                #print(down_num_step)
                for y in range(1,im+1,1):#y*10im
                   ...
                   # print(x2,y2,z2)
                    ...
                    if temp9>1000:
                        ...
                        down_num_step['down_{}_{}_step'.format(x,z)]=down_num_step['down_{}_{}_step'.format(x,z)]+1
                    else:
                        pass                     
                if down_num_step['down_{}_{}_step'.format(x,z)] == 0:
                    pass
                    #print(1)
                else:
                    print('down_{}_{}_step'.format(x,z)+'_'+str(down_num_step['down_{}_{}_step'.format(x,z)]))
                    down_num['down_{}_{}'.format(x,z)]=down_num['down_{}_{}'.format(x,z)]+down_num_step['down_{}_{}_step'.format(x,z)]
                    print('down_{}_{}'.format(x,z)+'_'+str(down_num['down_{}_{}'.format(x,z)]))
...
x=4
z=5
yy=(int('DOWN_{}_{}'.format(x,z)))
print('DOWN_{}_{}'.format(x,z))
print(DOWN_4_5)
print(yy)'''
'''
#down_num=dict(down_0_0=10,down_0_1=1,down_0_2=2)
...
x=7
y=1
#print(down_num['down_{}_{}'.format(x,y)])
print(down_num)'''