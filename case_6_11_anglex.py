...
line1 = Se.Line(point1 = (0.0,1.0),point2 = (1.0,0.4))
line2 = Se.Line(point1 = (1.0,0.4),point2 = (0.4,0.0))
line3 = Se.Line(point1 = (0.4,0.0),point2 = (0.0,0.0))
...
p1 = mdb.models['myModel'].parts['Part1']
vp.setValues(displayedObject=p1)
es = p1.edges
pt1 =p1.DatumPointByCoordinate(coords=())
